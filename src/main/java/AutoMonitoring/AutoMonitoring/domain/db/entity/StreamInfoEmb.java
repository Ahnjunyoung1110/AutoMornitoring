...
public class StreamInfoEmb {
    ...
    public static StreamInfoEmb fromDto(AutoMonitoring.AutoMonitoring.domain.dto.StreamDTO d) {
    ...
    public AutoMonitoring.AutoMonitoring.domain.dto.StreamDTO toDto() {
        return AutoMonitoring.AutoMonitoring.domain.dto.StreamDTO.builder()
